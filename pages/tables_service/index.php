...
<head>
  ...
  <script src="Js/daftarService.js"></script>
            ...
            <div class="container box">
			      <div class="table-responsive">	
				    <table id="Service_Data" class="table ">
					  <thead>
						<tr>
							<th width="25%">ID Daftar Service</th>
							<th width="25%">Nama Service</th>
                            <th width="20%">Harga Service</th>
                            <th width="20%">Edit</th>
        ...
        <form method="post" id="service_form" enctype="multipart/form-data">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Add Daftar Service Komputer</h4>
            </div>
            <div class="modal-body">
              ...
              <input type="text" name="harga_service" id="harga_service" class="form-control" />
              <br />
              <label>Toko Service</label>
              <input class="form-control" type="text" name="idService" id="idService" value="<?php require('sessionService.php'); echo $admin->idService;?>" readonly>
            </div>
            <div class="modal-footer">
              <input type="hidden" name="id_nama_service" id="id_nama_service" />
